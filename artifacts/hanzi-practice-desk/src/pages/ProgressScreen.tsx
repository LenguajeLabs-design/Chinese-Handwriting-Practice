  ...
  return (
    <div className="h-full overflow-y-auto">
      <div className="app-page">
        ...
        {charStats.length === 0 && (
          <div className="app-surface-strong px-6 py-8 md:px-8 md:py-10 text-center mb-6 md:mb-10">
            <div className="w-16 h-16 rounded-full bg-muted flex items-center justify-center mx-auto mb-4">
              <BarChart3 className="w-8 h-8 text-muted-foreground" />
            </div>
            <h2 className="text-xl font-medium mb-2">No practice history yet</h2>
            <p className="text-muted-foreground max-w-md mx-auto">
              Start tracing characters on the Practice screen to see your stats
              here. You can still sign in and turn on cloud sync now.
            </p>
          </div>
        )}
